...
print(f"Loading Nunchaku quantized Qwen Image Edit model (rank {rank})...")
print(f"Quantization: svdq-int4_r{rank} (~12.7GB)")
print("This model will fit comfortably on your RTX 4090 (24GB VRAM)")
...
inputs = {
    ...
    "true_cfg_scale": 4.0,
    "negative_prompt": " ",
    "num_inference_steps": 40,  # Standard 40 steps for quantized model
    "guidance_scale": 1.0,
...
print(f"Inference steps: {inputs['num_inference_steps']}")
